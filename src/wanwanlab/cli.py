"""Thin package CLI for routing to existing WanwanLab training entrypoints."""
...
from wanwanlab.demo import run_demo
...
def _train_eval_parser(*, mode: str) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--algo", default="ppo", choices=SUPPORTED_ALGOS)
    parser.add_argument("--task", default="x2_walk_flat")
    parser.add_argument("--sim", default="mujoco", choices=SUPPORTED_SIMS)
