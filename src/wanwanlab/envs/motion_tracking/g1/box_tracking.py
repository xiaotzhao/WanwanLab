...
from wanwanlab.dr import DomainRandomizationManager, ResetPlan
from wanwanlab.dr.dr_utils import build_common_reset_randomization, zero_actions
from wanwanlab.dtype_config import get_global_dtype
from wanwanlab.envs.common.math import np_sample_uniform
from wanwanlab.envs.common.rotation import (
    np_matrix_from_quat,
    np_quat_apply,
...
class G1BoxTrackingEnv(G1MotionTrackingEnv):
    ...
    def _compute_obs(
        ...
        # np_subtract_frame_transforms计算世界坐标系下两个位姿的相对位姿
