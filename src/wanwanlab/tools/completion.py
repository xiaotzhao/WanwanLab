...
from wanwanlab import cli

TRAINING_ENTRYPOINTS = {
    "train": "wanwanlab.cli:train_main",
    "eval": "wanwanlab.cli:eval_main",
}
...
COMPLETION_BLOCK_START = "# >>> wanwanlab completion >>>"
COMPLETION_BLOCK_END = "# <<< wanwanlab completion <<<"
...
def _install_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="wanwanlab-complete install")
